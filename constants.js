const MODEL_ROOT_PATH = './models';

// sorted least accurate to most accurate
const MODEL_PATHS = [
  'tinynet_b.in1k.onnx',
  'edgenext_small.usi_in1k.onnx',
  'edgenext_x_small.in1k.onnx',
  'tf_efficientnet_b3.ns_jft_in1k.onnx',
  'coat_mini.in1k.onnx',
  'mobilevit_xs.cvnets_in1k.onnx',
  'repvit_m1_0.dist_450e_in1k.onnx',
  'tiny_vit_5m_224.dist_in22k_ft_in1k.onnx',
  'eva02_tiny_patch14_336.mim_in22k_ft_in1k.onnx',
];
...
// looks ridiculous, but this is how ONNX works.
const ATTR_TYPE_MAP = {
...
const ALLOWED_INPUT = new Set(['Image', 'Weights', 'RandomNormal', 'Constant']);
const ALLOWED_OUTPUT = new Set(['Identity']);

const NODE_ATTR_FMT_EXCLUDE = new Set(['transA', 'transB']);
const NODE_ATTR_FMT = {
  keepdims: 'keepDims',
};
